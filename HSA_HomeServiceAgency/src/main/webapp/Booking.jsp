	...
	<section>
		<div class="container py-5" style="margin-top: 7%;">
			<div class="row border rounded-2 p-4">
				<div class="col-md-10">
					...
					<div class="row my-4">
						...
						<div class="col-md-4">
							...
							</label> <input class="form-control" type="date" name="sDate">
						</div>
						<div class="col-md-4">
							<label class="from-label mb-1"> Select service Time <span
								class="text-danger"> * </span>
							</label> <input class="form-control" type="time" name="sTime">
						</div>
					</div>
							...
							<c:forEach var="tempService" items="${services}">
								<div class="form-check form-check-inline me-4">
									<input class="form-check-input" type="checkbox"
										id="${tempService.price}" value="${tempService.sid}"
										name="subService"> 
									<label class="form-check-label text-secondary"
										for="${tempService.price}"> ${tempService.sname}
										(${tempService.price}/-)
									</label>
								</div>
							</c:forEach>
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-warning" style = "width:100%;">Book</a>
				</div>
			</div>
		</div>
	</section>
