		...
		<div class="container">
			...
			<div class="row mt-5 mb-3 founder_dp">
				<div class="col-lg-3 col-md-6 col-sm-12 text-center">
					<img src="./images/sourima.jpg" class="mb-3 mx-auto rounded-circle"
						style="width: 10rem; height: 10rem;" alt="Sourima" srcset="">
					<p class="fw-semibold fs-4 mb-0">Sourima Saha</p>
					<p class="text-secondary fw-light">(MCA 1st year), University
						of Calcutta</p>
				</div>
				<div class="col-lg-3 col-md-6  col-sm-12  text-center">
					<img src="./images/sarita.jpg" class="mb-3 mx-auto rounded-circle"
				...
				<div class="col-lg-3 col-md-6  col-sm-12  text-center">
					<img src="./images/akshay.jpg" class="mb-3 mx-auto rounded-circle"
						style="width: 10rem; height: 10rem;" alt="Akshay" srcset="">
					<p class="fw-semibold fs-4 mb-0">Akshay Kumar Das</p>
					<p class="text-secondary fw-light">(MCA 1st year), University
						of Calcutta</p>
				</div>
				<div class="col-lg-3 col-md-6  col-sm-12  text-center">
					<img src="./images/arijit.jpeg" class="mb-3 mx-auto rounded-circle"
						style="width: 10rem; height: 10rem;" alt="Arijit" srcset="">
